...
for kind,pid in [('TIKTOK_V2_ORIGINAL_ERROR','6ab1f12dffe5c8afb1291a9b'),('TIKTOK_V2_30FPS','6ab1f25574424003bca6ed63'),('TIKTOK_KEEPRY_V2_QUEUED','6ab1f356ffe5c8afb129534f'),('FACEBOOK_VISUAL','6ab1f12a6ed20e9354f5cfba')]:
    q='query { post(input:{id:'+json.dumps(pid)+'}) { id channelId status dueAt schedulingType externalLink sharedNow error { message supportUrl } assets { mimeType source } } }'
