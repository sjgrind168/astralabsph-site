...
lines += [
    ...
    "- [Work return handoff](../shared/ASTRALABS_WORK_RETURN_HANDOFF_20260922.md)",
    "",
    "## Fail-closed next steps",
    "1. Keep the existing FB two-per-app writer. Do not advertise 3/day as active until final original media and queue reconciliation.",
    "2. Preserve the 42-item plan in one location; promote a record only when its original media, rights and actual app proof pass.",
    "3. For Pinterest, correct printed artwork to root before enabling writes; verify exact dedicated Apps board in connected API.",
    "4. Keep TikTok/YouTube/IG/Reddit gates as documented; native permalink evidence is needed before claiming a live post.",
